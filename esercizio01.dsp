...
frq2 = vslider("f2 [style:knob] [unit:Hz]", 440,100,20000,1); 

pan3 = vslider("p3 [style:knob]", 0.5,0,1,0.01);
frq3 = vslider("f3 [style:knob] [unit:Hz]", 440,100,20000,1); 

pan4 = vslider("p4 [style:knob]", 0.5,0,1,0.01);
frq4 = vslider("f4 [style:knob] [unit:Hz]", 440,100,20000,1); 
